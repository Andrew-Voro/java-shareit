...
create TABLE IF NOT EXISTS items ( id BIGINT GENERATED ALWAYS AS IDENTITY PRIMARY KEY,
 ...
 CONSTRAINT fk_items_to_request FOREIGN KEY(request) REFERENCES requests(id),
 UNIQUE(id)
 );
...
/*create TABLE IF NOT EXISTS requests_items (
  item_id BIGINT ,
  request_id  BIGINT,
  CONSTRAINT fk_requests_items_to_request FOREIGN KEY(itemrequest_id) REFERENCES requests(id),
  CONSTRAINT fk_requests_items_to_items FOREIGN KEY(item_id) REFERENCES items(id)
);*/
